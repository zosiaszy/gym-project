...
const BuyMembership = () => (
  ...
  >
    ...
    >
      <Typography variant="h4" fontFamily="Alegreya" fontSize="40px" fontWeight="600" mb={2} color="#232227">
        READY for change?
      </Typography>
      <Typography variant="body1" fontFamily="Alegreya" fontSize="24px"  mb={2}>
       Choose the perfect membership for yourself and join 
       a community that values health and fitness!
