...
const Contact = () => (
  ...
  >
    ...
    >
      <Typography variant="h4" fontFamily="Alegreya" fontSize="45px" fontWeight="600" mb={2} color="#b48e70">
        CONTACT US
      </Typography>
...
<Typography variant="body1" fontFamily="Alegreya" fontSize="22px"  mb={2}>
     <b>Email:</b> elevate@fitness.com
      ...
      If you want to settle your outstanding payments, please use the account number: <b>14 1000 1063 0000 0021 3371 1952</b>
